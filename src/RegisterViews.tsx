...
export function RegisterTable({ title, registerName, rows, comparisonRows, focusedRecordId }: { title: string; registerName: string; rows: RegisterRow[]; comparisonRows: Project['registerComparisonRows']; focusedRecordId: string | null }) {
...
export function RegisterDetail({ row, comparisonRows, onClose }: { row: RegisterRow; comparisonRows: Project['registerComparisonRows']; onClose: () => void }) {
